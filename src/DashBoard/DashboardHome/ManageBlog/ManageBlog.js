...
const ManageBlog = () => {
    ...
    const handleDltBtn = id => {
        ...
        if(confirmMsg){
            console.log(id)
            axios.delete(`http://localhost:8080/api/blog/deleteblog/${id}`,  {
            headers: {
                "Content-Type": "application/json"
            }
            }).then((res)=> {
                            ...
                            <div className='blogBox'>
                                ...
                                <div className='blogBoxContent'>
                                    <div>
                                        ...
                                        <div className="blogTitle">
                                            <Link to="/updateBlog"><button className='editBtn'><i className="fa-solid fa-pen-clip"></i> Edit</button></Link>
